...
<div class="container">
    ...
    <div class="form-group">
        <label for="pwd">Estado Disquera<span class="text-danger"></span></label>
        <div>
          <input type="checkbox" name="estadoDisquera" id="estado" checked>
          <label for="chkestado"> Activo</label>
      </div>
      <button type="submit" name="accion" value="Add">Ingresar</button>
    </form>
  </div>
</div>
</body>
